 ...
 */
package com.yogee.yogee.common.utils.io;

import com.yogee.yogee.common.utils.collect.SetUtils;
...
public class PropertiesUtils {
	...
	private static final class PropertiesLoaderHolder {
		...
		public static void releadInstance(){
			...
			Resource[] resources = ResourceUtils.getResources("classpath*:/config/yogee-*.*");
			...
			logger.debug("Loading yogee config: {}", configFiles);
