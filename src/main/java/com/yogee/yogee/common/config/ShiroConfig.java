package com.yogee.yogee.common.config;

import com.yogee.yogee.common.security.shiro.session.CacheSessionDAO;
import com.yogee.yogee.common.security.shiro.session.SessionManager;
import com.yogee.yogee.module.sys.security.FormAuthenticationFilter;
import com.yogee.yogee.module.sys.security.SystemAuthorizingRealm;
...
public class ShiroConfig {
    ...
    public SessionManager sessionManager(CacheSessionDAO dao) {
        ...
        sessionManager.setSessionIdCookie(new SimpleCookie("yogee.yogee.session.id"));
